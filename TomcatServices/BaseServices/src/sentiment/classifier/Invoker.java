...
/**
 * 
 * class that aggregates all sentiment.commands and delegates them the actions' execution 
 *
 */
public class Invoker {
	 ...
	 * @param cc command that represent the action for constructing a sentiment.classifier
	 * @param cwmc command that represent the action for constructing a weighted majority sentiment.classifier
	...
	/**
	 * invokes command for constructing a sentiment.classifier
	 */
	...
	/**
	 * invokes command for constructing weighted majority sentiment.classifier
	 */
	...
	/**
	 * invokes command for calculating weighted majority sentiment.classifier's precision
	 */
