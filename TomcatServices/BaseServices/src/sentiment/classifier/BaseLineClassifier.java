...
/**
 * a sentiment.classifier that only counts positive and negative terms from given lists
 */
public class BaseLineClassifier implements IClassifier {
	...
	public void evaluate() throws Exception {
		...
		res_pos = extractFeatures(Utils.getFilesRoot() + "pos.txt");
		res_neg = extractFeatures(Utils.getFilesRoot() + "neg.txt");
		int pos = 0;
		int neg = 0;
		String strLine, pol;
		int i = 0;
