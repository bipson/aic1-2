...
/**
 * class representing a sentiment.classifier in Weka
 *
 */
public class WekaClassifier implements IClassifier, Serializable {
	...
	public WekaClassifier() throws Exception {
		DataSource source_train = new DataSource(Utils.getFilesRoot() + "train1.arff");
		DataSource source_test = new DataSource(Utils.getFilesRoot() + "test1.arff");
	...
	/**
	 * sets a sentiment.classifier for the class
	 * @param sentiment.classifier represented by class
	 */
	...
	/**
	 * evaluates the sentiment.classifier 
	 */
	@Override
	public void evaluate() throws Exception {
		// evaluate sentiment.classifier and print some statistics
