...
public class Features {
	...
	/**
	 * gets the sentiment.documents set where there are these features
	 * @return the sentiment.documents set where there are these features
	 */
	...
	/**
	 * sets a given sentiment.documents set where there are these features
	 * @param ds a sentiment.documents set where there are these features
	 */
	...
	public List<String> createListStopwords() throws IOException {
		...
		FileInputStream fstream = new FileInputStream(Utils.getFilesRoot() + "stopwords.txt");
	...
	/**
	 * creates new maps that contains only features that appear a given number of times (in ALL processed tweets) 
